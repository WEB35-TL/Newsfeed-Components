...
function articleMaker(arr) {
  ...
  first.innerHTML = arr.firstParagraph
  second.innerHTML = arr.secondParagraph
  third.innerHTML = arr.thirdParagraph
  ...
  // expand article functionality
  expand.addEventListener('click', () =>
    parent.classList.toggle('article-open')
  )

  // append all elements to parent
  parent.append(title, date, first, second, third, expand)
